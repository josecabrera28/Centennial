...
namespace Atom
{
    public class Atom
    {
        ...
        public static void WriteXml(List<Atom> atoms, string filename)
        {
            ...
            serializer.Serialize(writer, firstAtom);
        }
        ...
        public static void ReadXml(string filename)
        {
            ...
            List<Atom> elements = (List<Atom>)serializer.Deserialize(reader);
        }

        public static void WriteFirstAtomJson(Atom atom, string filename)
        {
            File.WriteAllText(filename, JsonSerializer.Serialize(atom));
        }

        public static void ReadFirstAtomJson(string filename)
        {
            TextReader reader = new StreamReader(filename);
        ...
        {
            TextReader reader = new StreamReader(filename);
            List<Atom> atomList = JsonSerializer.Deserialize<List<Atom>>(reader.ReadToEnd());
            Atom.DisplayElements(atomList);
        }
        public static void DisplayElements(List<Atom> listAtoms)
        {
            foreach (Atom atom in listAtoms)
            {
